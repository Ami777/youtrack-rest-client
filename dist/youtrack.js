...
class Youtrack {
    constructor(options) {
        ...
        this.defaultRequestOptions = Object.assign(Object.assign({}, this.defaultRequestOptions), { headers: {
    ...
    prepareParams(params, customHeaders) {
        if ('headers' in this.defaultRequestOptions && Object.keys(customHeaders).length > 0) {
            ...
            return Object.assign(Object.assign(Object.assign({}, defaultOptions), params), { headers: Object.assign(Object.assign({}, headers), customHeaders) });
        }
        if ('headers' in this.defaultRequestOptions) {
            return Object.assign(Object.assign({}, this.defaultRequestOptions), params);
        }
        return Object.assign(Object.assign(Object.assign({}, this.defaultRequestOptions), params), { headers: Object.assign({}, customHeaders) });
    }
}
